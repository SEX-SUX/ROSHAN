...
def stream_markup_timer(_, videoid, chat_id, played, dur):
    ...
    buttons = [
        ...
        [
            InlineKeyboardButton(text="ᴜᴘᴅᴀᴛᴇ", url ="https://t.me/SANATANI_TECH",),
            InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", url="https://t.me/+Ckzm2ypQyIIzZTll",),
        ],
        [
...
def stream_markup(_, videoid, chat_id):
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text="ᴜᴘᴅᴀᴛᴇ", url="https://t.me/SANATANI_TECH",
            ),
            InlineKeyboardButton(
                text="sᴜᴘᴘᴏʀᴛ", url="https://t.me/+Ckzm2ypQyIIzZTll",
            )
        ],
        [InlineKeyboardButton(text=_["CLOSE_BUTTON"], callback_data="close")],
    ]
